        ...
        <div className="px-4 sm:px-6">
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSdLql9wxVoGHg3zOdDFhA1pZpny6IGjp_230U4bbQtd0-QF-g/viewform?usp=dialog"
                  target="_blank"
              ...
              <div className="flex flex-col gap-1">
                {navItems.map((item) => (
                  <Button
                    ...
                    variant="ghost"
                    asChild
                    className="justify-start rounded-xl px-3 py-2 text-[14px] font-medium text-white hover:bg-white/5"
                  >
                    {item.href.startsWith("/") ? (
                      <Link
                        to={item.href}
                ...
                <Button
                  className="mt-2 h-10 w-full rounded-full px-4 text-[13px] font-semibold text-slate-950 bg-[linear-gradient(180deg,#FFB899_0%,#FF9F7A_100%)] hover:brightness-110 shadow-[0_6px_20px_rgba(255,159,122,0.35)]"
                  asChild
                >
                  <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSdLql9wxVoGHg3zOdDFhA1pZpny6IGjp_230U4bbQtd0-QF-g/viewform?usp=dialog"
